          ...
          <div className="flex bg-white/80 backdrop-blur-md p-1.5 rounded-2xl shadow-sm border border-slate-100 flex-1 xl:flex-none overflow-x-auto scrollbar-hide">
            {['All', 'Confidential', 'Intervention', 'Legal'].map(f => (
              <button
                ...
                className={`flex-1 px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${docFilter === f ? 'bg-slate-900 text-white shadow-lg' : 'text-slate-500 hover:bg-slate-50'
                  }`}
              >
                {f}
              </button>
        ...
        <div className="flex bg-white/80 backdrop-blur-md p-1.5 rounded-[22px] shadow-sm border border-slate-100 w-full lg:w-auto overflow-x-auto scrollbar-hide">
          {[
            ...
            <button
              ...
              className={`flex-1 lg:flex-none px-6 py-3 rounded-[18px] text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 whitespace-nowrap ${activeTab === tab.id ? 'bg-slate-900 text-white shadow-xl' : 'text-slate-500 hover:bg-slate-50'
                }`}
            >
              {tab.icon} {tab.label}
            </button>
