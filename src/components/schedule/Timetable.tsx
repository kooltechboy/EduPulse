...
import { ChevronLeft, ChevronRight, Filter, Sparkles, AlertTriangle, CheckCircle, RefreshCw, Zap } from 'lucide-react';
...
export const Timetable: React.FC = () => {
  ...
  const handleAutoResolve = () => {
    ...
    setTimeout(() => {
      ...
      alert('AI Schedule Conflict Resolver successfully relocated AP Chemistry to Tuesday 11:00 AM (Lab 1) with 0 remaining overlaps!');
    }, 1200);
  };
  ...
  return (
    <div className="ep-timetable">
      ...
      {/* Conflict Modal */}
      {showConflictModal && (
        <div className="ep-modal-overlay" onClick={() => setShowConflictModal(false)}>
