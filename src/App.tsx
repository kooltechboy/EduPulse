        ...
        isAuthenticated && user ? (
          <Layout user={user} onLogout={logout}>
            <Routes>
              ...
              <Route path="/immersive-studio" element={
                <PlanGate minPlan="enterprise" featureName="Immersive Studio">
                  <ImmersiveStudio />
                </PlanGate>
              } />
              <Route path="/trajectory-matrix" element={
                <PlanGate minPlan="premium" featureName="Destiny Matrix">
                  <TrajectoryModel />
                </PlanGate>
              } />
              <Route path="/live-tutor" element={
                <PlanGate minPlan="premium" featureName="AI Live Tutor">
                  <LiveTutor />
                </PlanGate>
              } />
